...
const center = { lat: 27.3389, lng: 88.6139 };
            ...
            <li key={m.id} style={{ marginBottom: 8 }}>
              ...
              >
                ...
                <div style={{ fontSize: 12, color: "#666" }}>
                  {m.district || "Sikkim"} • {m.sect || "Buddhist"}
                </div>
              </button>
            </li>
          ))}
            ...
            >
              <div style={{ maxWidth: 240 }}>
                ...
                <div style={{ fontSize: 13 }}>
                  {selected.district || "Sikkim"} • {selected.sect || "Buddhist"}
                </div>
                <p style={{ margin: "6px 0 0 0", fontSize: 13 }}>
                  {selected.notes || "One of the important monasteries in Sikkim."}
                </p>
